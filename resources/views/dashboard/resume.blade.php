...
@section('content')
    ...
    <div class="row px-4 w-100 my-5">
        <div class="col">
            <a class="btn btn-primary rounded-pill px-4 py-2 shadow-lg hover-shadow bg-white rounded text-dark"
                href="{{ route('profile') }}">Go Back</a>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body rounded">
                <form method="POST" action="{{ route('resume') }}" onsubmit="getAll()">
                    ...
                    <div class="mb-3">
                        <div class="personal">
                            <label for="division"> Personal Information </label>
                        ...
                        <div class="mb-3">
                            <button class="btn button" type="button" data-bs-target="#workModal"
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <button type="submit" class="btn rounded-pill px-4 py-2 shadow-lg hover-shadow"
                                style="background-color:blue; ">Submit Resume </button>
                        </div>
